        ...
        <section id="faq" className="my-20 max-w-5xl mx-auto px-6 scroll-mt-20">
          ...
          <div id="contacto" className="mt-12 text-center bg-gradient-to-r from-[#0B1829] to-[#153047] rounded-2xl p-10 shadow-xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <button
                onClick={openContact}
                className="bg-gradient-to-r from-cyan-400 to-cyan-500 text-[#0B1829] px-8 py-3 rounded-full font-bold text-lg hover:from-cyan-300 hover:to-cyan-400 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-2xl"
              >
